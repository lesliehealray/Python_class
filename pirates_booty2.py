...
def treasure_amount():
    ...
    if loot_bag % 2:
       ...
       return 'Your loot has increased %d times for a grand total of %d' % (treasure, new_balance)
    else:
        print_treasure('X')
        new_balance = total - 10
        return "So sorry. You've found a money sucker. Your loot is now %d" % new_balance
...
choices = [
    "Grab your loot and spend it on hotties and cheap booze.",
